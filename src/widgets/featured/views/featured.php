...
<div class="row">
    <?php foreach ($products as $product): ?>
        <?php $url = Url::to(['/catalog/catalog/product', 'id' =>$product->id]); ?>
            ...
            <div class="product-thumb transition">
                ...
                <div>
                    ...
                    <div class="button-group">
                        <button type="button" href="<?= Url::to(['/catalog/cart/add', 'id' => $product->id]) ?>" data-method="post"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md">Add to Cart</span></button>
