...
class m250428_122910_create_catalog_categories_table extends BaseMigration
{
    public const string TABLE_NAME = '{{%catalog_categories}}';
    ...
    public function safeUp(): void
    {
        ...
        $this->addCommentOnTable(static::TABLE_NAME, 'Категория товара');
